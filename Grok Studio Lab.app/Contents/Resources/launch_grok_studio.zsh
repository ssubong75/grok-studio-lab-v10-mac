...
DATA_HOME_BASE="$HOME/Library/Application Support/Grok Studio Lab"
DEFAULT_DATA_HOME="$DATA_HOME_BASE/grok_studio_data"
FALLBACK_DATA_BASE="$DATA_HOME_BASE/Instances"
FOLDER_DATA_HOME="$APP_PARENT/grok_studio_data"
...
elif [[ -f "$APP_PARENT/grok_studio.py" ]]; then
  DATA_HOME="$FOLDER_DATA_HOME"
